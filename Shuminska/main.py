...
pygame.display.set_caption("20 Minutes Like Game")


hero_image = pygame.image.load("hero.png").convert_alpha()
monster_image = pygame.image.load("monster.jpg").convert_alpha()
...
monsters = [Monster(health=50, damage=10, x=random.randint(600, 780), y=random.randint(50, 550)) for _ in range(5)]
bullets = []
